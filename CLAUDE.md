...
- After making code changes, run `bun verify-full` to execute all tests (takes up to 1 hour), or `bun verify` for only type checking and linting (takes up to 10 minutes).
