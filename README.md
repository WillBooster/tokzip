...
[`tokzip-corpus`](https://github.com/WillBooster/tokzip-corpus) commit (~1,600 documents
sampled from one pinned OSS repo per language plus natural-language sources; a language
...
Latest local run (`bench-v1`, fingerprint `3d3078824b99`, 1,581 documents, ~10.8 MB,
...
| javascript   |    4 |       45.8% |        34.0% |              31.5% |           36.5% |            34.9% |
...
| en-US        |  245 |       67.1% |        51.5% |              44.1% |           55.1% |            53.1% |
| ja-JP        |  129 |       65.7% |        51.8% |              46.9% |           53.5% |            50.6% |
| **all (20)** | 1581 |   **56.9%** |    **44.4%** |          **41.0%** |       **48.9%** |        **46.4%** |

On this per-document workload, tokzip `fast` compresses/decompresses at 21.9/162.1 MB/s
(3.4/24.9 thousand documents/s), and `small` at 7.4/70.7 MB/s. Brotli q11 reaches the
smallest overall output but compresses at 1.2 MB/s; zstd -3 reaches 265.2 MB/s but emits
51.3% of the input size after base64url framing.
