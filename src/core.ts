...
export interface Codec {
   ...
   * binary frame. First use initializes each required dictionary and its group's shared
   * model priors; later calls reuse them.
   */
  ...
  return {
    ...
    decompress(frame, { maxLength = Number.POSITIVE_INFINITY } = {}) {
      ...
      return withInput(frame, (exports, ptr, len) => {
        ...
        const out = new Uint8Array(exports.memory.buffer, exports.tokzip_out_ptr(), exports.tokzip_out_len());
        try {
